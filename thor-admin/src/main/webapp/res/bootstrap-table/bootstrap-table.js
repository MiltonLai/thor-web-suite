...
!function ($) {
        ...
        $.each(this.options.columns, function (i, columns) {
            ...
            $.each(columns, function (j, column) {
                ...
                if (typeof column.fieldIndex !== 'undefined') {
                    ...
                    that.header.sortFields[column.fieldIndex] = column.sortField;
    ...
    BootstrapTable.prototype.onSort = function (event) {
        ...
        if ($this.data('sort-field') === undefined) {
            this.options.sortField = this.options.sortName;
        } else {
            this.options.sortField = $this.data('sort-field');
        }
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        var that = this,
            ...
            params = {
                ...
                sortName: this.options.sortField,
                sortOrder: (this.options.sortOrder === 'desc') ? 0 : 1
            },
            request;
